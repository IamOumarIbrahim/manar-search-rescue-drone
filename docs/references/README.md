...
This directory contains the curated technical research reference library for **MANAR (منار)** — a multisensor search-and-rescue UAV system. For architectural inspiration and comparisons with existing open-source systems, see [REFERENCES.md](REFERENCES.md).
